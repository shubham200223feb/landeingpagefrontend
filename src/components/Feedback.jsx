          ...
          <form className="flex flex-col items-center text-sm  w-full h-full">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 w-[350px] md:w-[700px]">
                <div className="w-full">
                    ...
                    <input name="name" value={data.name}  onChange={change} className="h-12 p-2 mt-2 w-full border border-gray-500/30 rounded outline-none focus:border-indigo-300" type="text" required />
                </div>
                <div className="w-full">
